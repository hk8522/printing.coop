      ...
      <div class="tem-visibility" style="z-index: 99; padding: 20px;">
        ...
        ?>
          <div style="width: 100%;display: flex;align-items: center;border-bottom: 1px solid #ccc;padding: 20px 0px; flex-wrap: wrap;">
                  ...
                  <div style="margin: 10px 0px 0px 0px">
                    <?php if (!empty($product_width_length)) { ?>
                      ...
                      <?php if (!empty($product_width_length['length_width_color_show'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Colors:</font> <?= $product_width_length['length_width_color'] ?></div>
                      <?php } ?>

                      <?php if (!empty($product_width_length['product_total_page'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Quantity:</font> <?= $product_width_length['product_total_page'] ?></div>
                      <?php } ?>
                    <?php } ?>
                    <?php if (!empty($product_depth_length_width)) { ?>
                      ...
                      <?php if (!empty($product_depth_length_width['depth_color_show'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Colors:</font> <?= $product_depth_length_width['depth_color'] ?></div>
                      <?php } ?>

                      <?php if (!empty($product_depth_length_width['product_depth_total_page'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Quantity:</font> <?= $product_depth_length_width['product_depth_total_page'] ?></div>
                      <?php } ?>
                    <?php } ?>
                    ...
                    <?php if (!empty($page_product_width_length)) { ?>
                      ...
                      <?php if (!empty($page_product_width_length['page_length_width_color_show'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Colors:</font> <?= $page_product_width_length['page_length_width_color'] ?></div>
                      <?php } ?>

                      <?php if (!empty($page_product_width_length['page_product_total_page'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Pages:</font> <?= $page_product_width_length['page_product_total_page'] ?></div>
                      <?php } ?>

                      <?php if (!empty($page_product_width_length['page_product_total_sheets'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Sheet Per Pad:</font> <?= $page_product_width_length['page_product_total_sheets'] ?></div>
                      <?php } ?>

                      <?php if (!empty($page_product_width_length['page_product_total_quantity'])) { ?>
                        <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Quantity:</font> <?= $page_product_width_length['page_product_total_quantity'] ?></div>
                      <?php } ?>
                    <?php } ?>
                    ...
                    <?php $this->view('Emails/expand_attribute_ids', ['attribute_ids' => $attribute_ids]); ?>
                    ...
                    <?php if (!empty($votre_text)) { ?>
                      <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Your TEXT - Votre TEXT:</font> <?= $votre_text ?></div>
                    <?php } ?>
                    ...
                    <?php if (!empty($cart_images)) {
                      ...
                      ?>
                        ...
                        <?php if (!empty($return_arr['cumment'])) { ?>
                          <br>
                          <div style="font-size: 14px;color: #666; font-weight: 400; margin: 0px 0px 5px 0px;"><font style="color: #222">Comment:</font> <?= $return_arr['cumment'] ?></div>
                        <?php } ?>
                      <?php }
                    } ?>
                  </div>
            ...
            <div style="width: 50%; text-align: left;">
              <div style="font-size: 14px;color: #303030;"><font style="color: #000; font-weight: 600;">Price :</font> <?= $order_currency_currency_symbol.number_format($item['price'],2) ?></div>
            </div>
            <div style="width: 50%; text-align: right">
              <div style="font-size: 14px;color: #303030;"><font style="color: #000; font-weight: 600;">Subtotal :</font>
                <?php
        ...
        <div style="width: 100%;display: flex;align-items: center;padding: 10px 0px 0px 0px;">
          <div style="width: 100%;display: flex;">
            ...
            <div style="width: 30%; text-align: right;">
              <span style="font-size: 16px;color: #f58634;font-weight: 600;">
