...
?><?php
$this->view('elements/HomeSections/section_5.php'); #Our Promise To You Section?><?php
$this->view('elements/HomeSections/section_6.php'); #Main Services  Section?><?php
$this->view('elements/HomeSections/section_7.php'); #REGISTER FOR FREE!  Section?><?php
//$this->view('elements/HomeSections/covind19-msg.php'); #covind19 message
