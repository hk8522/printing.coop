             ...
             ?>
                        ...
                        <div class="single-blog-area">
                            ...
                            <div class="single-blog-box-inner">
                                <div class="single-blog-category">
                                    <a href="<?= $BASE_URL?>Blogs/category/<?= base64_encode($blog['category_id']) ?>">
                                    <span>
                                    <?php
                                ...
                                <div class="universal-small-dark-title">
                                    <span><a href="<?= $BASE_URL?>Blogs/singleview/<?= base64_encode($blog['id']) ?>"><?php
                                         if ($this->language_name == 'French') {
                ...
                <?php
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 text-center">
                            ...
                            <?= $this->language_name == 'French'? 'Aucun blog trouvé':'No blog found' ?>
