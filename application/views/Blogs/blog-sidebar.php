<div class="blog-sidebar">
    ...
    <div class="blog-sidebar-posts">
        <ul class="nav nav-pills">
            <li><a class="active" data-toggle="pill" href="#Popular"><?= $this->language_name == 'French'? 'Populaire':'Popular' ?></a></li>
            <li><a class="" data-toggle="pill" href="#Latest"><?= $this->language_name == 'French'? 'dernière':'Latest' ?></a></li>
        </ul>
        <div class="tab-content">
            <div id="Popular" class="tab-pane fade active show">
               <?php foreach ($popularblogs as $pblog) {
                ...
                <div class="blog-sidebar-single-post">
                    <a href="<?= $BASE_URL?>Blogs/singleview/<?= base64_encode($pblog['id']) ?>">
            ...
            <?php foreach ($latestblogs as $lblog) {
                 ...
                 ?>
                <div class="blog-sidebar-single-post">
                    <a href="<?= $BASE_URL?>Blogs/singleview/<?= base64_encode($lblog['id']) ?>">
                        <div class="blog-sidebar-single-post-img" style="background-image: url(<?= $imageurl ?>)"></div>
                        <div class="blog-sidebar-single-detail">
                            <div class="single-blog-title">
                                <span><?php if ($this->language_name == 'French') {
    ...
    <div class="blog-category-sidebar">
        <div class="universal-dark-title">
            <span><?= $this->language_name == 'French'? 'Catégories':'Categories' ?></span>
        </div>
        <div class="blog-category-list">
            <?php foreach ($category as $cat) {
            ?>
            <a href="<?= $BASE_URL?>Blogs/category/<?= base64_encode($cat['id']) ?>"><i class="las la-folder-open"></i><?php
