                ...
                <div class="col-md-7">
                  <div class="form-role-area">
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="span2" for="multiple-category">Select Fields</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                            <div class="row">
                              <div class="col-md-12">
                                <select id="multiple-category" class="form-control selectpicker" multiple=""
                              ...
                              <div class="col-md-12">
                                <select id="multiple-brand" class="form-control selectpicker" multiple=""
                                  data-live-search="true">
                              ...
                              <div class="col-md-12">
                                <select id="multiple-products" class="form-control selectpicker" multiple=""
                                  data-live-search="true">
                    ...
                    <div class="control-group info">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="row">
                            <div class="col-md-6">
                              <label class="span2" id="show-discount-percent"><input type="radio" name="discount"
                                  value="discountpercent" checked="">Discount Percent</label>
                            </div>
                            <div class="col-md-6">
                              <label class="span2" id="show-discount-amount"><input type="radio" name="discount"
                                  value="discountamount">Discount Amount</label>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="span2" for="DiscountValid">Discount Valid</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                            <div class="row">
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="span2" for="show-minimum">Discount Requirements</label>
                        </div>
                        <div class="col-md-8">
                          <div class="row">
                            <div class="col-md-6">
                              <label class="span2" id="show-minimum"><input type="radio" name="quantity" value="minimum"
                                  checked="">Minimum Quantity</label>
                            </div>
                            <div class="col-md-6">
                              <label class="span2" id="show-maximum"><input type="radio" name="quantity"
                                  value="maximum">Maximum Quantity</label>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        <div class="col-md-4">
                          <label class="span2" for="discount">Discount Code Limit</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
