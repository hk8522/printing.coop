                  ...
                  <div class="form-role-area">
                    <div class="control-group info">
                      <div class="row align-items-center">
                        <div class="col-md-4">
                          <label class="span2" for="name">Brand Name</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        <div class="col-md-4">
                          <label class="span2" for="short_description">Brand Short Description</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        <div class="col-md-4">
                          <label class="span2" for="full_description">Brand Full Description</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                            <textarea class="form-control"
                              name="full_description"><?= isset($postData['full_description']) ? $postData['full_description'] : '' ?></textarea>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-4">
                          <label class="span2" for="image">Upload Image</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                            <div class="col-xs-3" style="margin-bottom:15px;">
                              <?php
                              $old_image = isset($postData['brand_image']) ? $postData['brand_image'] : '';
                              if ($old_image != '') {
