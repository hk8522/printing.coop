                  ...
                  <div class="form-role-area">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <!---<input class="form-control" name="short_description" id="short_description" type="text" placeholder="short description" value="<?= isset($postData['short_description']) ? $postData['short_description'] : '' ?>">
                            <?= form_error('short_description') ?>-->
                            <textarea class="form-control"
                              name="short_description"><?= isset($postData['short_description']) ? $postData['short_description'] : '' ?></textarea>
                            <?= form_error('short_description') ?>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <!--<input class="form-control" name="short_description_french" id="short_description_french" type="text" placeholder="French short description" value="<?= isset($postData['short_description_french']) ? $postData['short_description_french'] : '' ?>">
                            <?= form_error('short_description_french') ?>-->

                            <textarea class="form-control"
                              name="short_description_french"><?= isset($postData['short_description_french']) ? $postData['short_description_french'] : '' ?></textarea>
                            <?= form_error('short_description_french') ?>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <textarea class="form-control" name="full_description"
                              id="content"
                              maxlength="100"><?= isset($postData['full_description']) ? $postData['full_description'] : '' ?></textarea>
                            <?= form_error('full_description') ?>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <textarea class="form-control" name="full_description_french"
                              id="content1"
                              maxlength="100"><?= isset($postData['full_description_french']) ? $postData['full_description_french'] : '' ?></textarea>
                            <?= form_error('full_description_french') ?>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <div class="row align-items-center">
                              ...
                              <!--<div class="col-md-3">
                                <input class="form-control" name="price_euro" id="price_euro" type="text" placeholder="List Price EURO" value="<?= isset($postData['price_euro']) ? showValue($postData['price_euro']) : '' ?>">
                                <label class="form-inner-label">List Price EURO</label>
                                <?= form_error('price_euro') ?>
                              </div>

                               <div class="col-md-3">
                                <input class="form-control" name="price_gbp" id="price_gbp" type="text" placeholder="Product Price" value="<?= isset($postData['price_gbp']) ? showValue($postData['price_gbp']) : '' ?>">
                                <label class="form-inner-label">List Price GBP</label>
                                <?= form_error('price_gbp') ?>
                              </div>
                               <div class="col-md-3">
                                <input class="form-control" name="price_usd" id="price_usd" type="text" placeholder="Product Price" value="<?= isset($postData['price_usd']) ? showValue($postData['price_usd']) : '' ?>">
                                <label class="form-inner-label">List Price USD</label>
                                <?= form_error('price_usd') ?>
                              </div>-->
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <input class="form-control" name="model_french"
                                  ...
                                  value="<?= isset($postData['model_french']) ? $postData['model_french'] : '' ?>">
                                <label class="form-inner-label">French Models</label>
                                <?= form_error('model_french') ?>
                              </div>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="text">Your TEXT - Votre TEXT</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="recto_verso">Recto/Verso</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                            <div class="row">
                                  ...
                                  <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                      <div class="attribute-info-inner">
                                        <input type="text"
                                          value="<?= showValue($postData['recto_verso_price']) ?>"
                                          name="recto_verso_price"
                                          onkeypress="javascript:return isNumber(event)"
                                          placeholder="Percentage"
                                          class="form-control LengthWidth">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="use_custom_size">Product Custom Size</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                            <label class="span2">
                              <input type="checkbox" <?= $postData['use_custom_size'] == 1 ? 'checked' : '' ?>
                                id="use_custom_size" name="use_custom_size" value="1">
                            </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="add_length_width">Product Custom Add Length And Width</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                            <div class="row">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['min_length']) ?>"
                                            name="min_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control LengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['max_length']) ?>"
                                            name="max_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control LengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['min_width']) ?>"
                                            name="min_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control LengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['max_width']) ?>"
                                            name="max_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control LengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['min_length_min_width_price']) ?>"
                                            name="min_length_min_width_price"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['length_width_price_color']) ?>"
                                            name="length_width_price_color"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['length_width_unit_price_black']) ?>"
                                            name="length_width_unit_price_black"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['length_width_min_quantity']) ?>"
                                            name="length_width_min_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['length_width_max_quantity']) ?>"
                                            name="length_width_max_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="page_add_length_width">Page Size Length And Width</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_min_length']) ?>"
                                            name="page_min_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control PageLengthWidth">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_max_length']) ?>"
                                            name="page_max_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control PageLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_min_width']) ?>"
                                            name="page_min_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control PageLengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_max_width']) ?>"
                                            name="page_max_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control PageLengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_min_length_min_width_price']) ?>"
                                            name="page_min_length_min_width_price"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control PageLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_length_width_price_color']) ?>"
                                            name="page_length_width_price_color"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_length_width_price_black']) ?>"
                                            name="page_length_width_price_black"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          ...
                                          <select class="form-control"
                                            name="page_length_width_pages_type">

                                            <!--<option value="dropdown" <?= $postData['page_length_width_pages_type'] == 'dropdown' ? 'selected' : '' ?>>
                        Dropdown
                      </option>-->
                                    ...
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          ...
                                          <select class="form-control"
                                            name="page_length_width_sheets_type">

                                            <option value="dropdown"
                                              <?= $postData['page_length_width_sheets_type'] == 'dropdown' ? 'selected' : '' ?>>
                                              Dropdown
                                            </option>
                                            <option value="input"
                                              <?= $postData['page_length_width_sheets_type'] == 'input' ? 'selected' : '' ?>>
                                              Input
                                            </option>
                                    ...
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          ...
                                          <select class="form-control"
                                            name="page_length_width_quantity_type">

                                            <option value="input"
                                              <?= $postData['page_length_width_quantity_type'] == 'input' ? 'selected' : '' ?>>
                                              Input
                                            </option>
                                            <option value="dropdown"
                                              <?= $postData['page_length_width_quantity_type'] == 'dropdown' ? 'selected' : '' ?>>
                                              Dropdown
                                            </option>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_length_width_min_quantity']) ?>"
                                            name="page_length_width_min_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum Quantity"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['page_length_width_max_quantity']) ?>"
                                            name="page_length_width_max_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum Quantity"
                                            class="form-control LengthWidth">
                                        </div>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        <div class="col-md-3">
                          <label class="span2" for="depth_add_length_width">Add Length X Width X Depth</label>
                        </div>
                        <div class="col-md-9">
                          <div class="controls small-controls">
                            <div class="row">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_min_length']) ?>"
                                            name="depth_min_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum Length"
                                            class="form-control DepthLengthWidth">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_max_length']) ?>"
                                            name="depth_max_length"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control DepthLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_min_width']) ?>"
                                            name="depth_min_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control DepthLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_max_width']) ?>"
                                            name="depth_max_width"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control DepthLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['min_depth']) ?>"
                                            name="min_depth"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum"
                                            class="form-control DepthLengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['max_depth']) ?>"
                                            name="max_depth"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum"
                                            class="form-control DepthLengthWidth">
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_width_length_price']) ?>"
                                            name="depth_width_length_price"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control DepthLengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_price_color']) ?>"
                                            name="depth_price_color"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_unit_price_black']) ?>"
                                            name="depth_unit_price_black"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Price"
                                            class="form-control LengthWidth">
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          ...
                                          <select class="form-control"
                                            name="depth_width_length_type">

                                            <option value="input"
                                              <?= $postData['depth_width_length_type'] == 'input' ? 'selected' : '' ?>>
                                              Input
                                            </option>
                                          </select>
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_min_quantity']) ?>"
                                            name="depth_min_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Minimum Quantity"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= showValue($postData['depth_max_quantity']) ?>"
                                            name="depth_max_quantity"
                                            onkeypress="javascript:return isNumber(event)"
                                            placeholder="Maximum Quantity"
                                            class="form-control LengthWidth">
                                        </div>
                                  ...
                                  <div class="attribute-info">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col-md-6">
                                        <div class="attribute-info-inner">
                                          <input type="text"
                                            value="<?= isset($postData['phone_number']) ? $postData['phone_number'] : '1-877-384-8043' ?>"
                                            name="phone_number"
                                            maxlength="15"
                                            style="width:100%">
                                        </div>
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            ...
                            <div class="col-xs-4" style="margin-bottom:15px;"
                              ...
                              <input name="old_image[]" value="<?= $list['image'] ?>" type="hidden">
                              &nbsp;&nbsp;
...
<script>
var default_url_image = '<?= $BASE_URL ?>/assets/images/no-image.png'
...
function remove_image(id, image_name) {
  ...
  $.ajax({
    type: 'POST',
    dataType: 'html',
    //url: '<?= $BASE_URL ?>admin/Ajax/removeProductImage/'+product_id+'/'+id+'/'+image_name,
    url: '<?= $BASE_URL ?>admin/Ajax/removeProductImage/',
    data: {
