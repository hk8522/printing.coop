                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="product-view-display">
                                                                    <span>
                                                                        <?= $StoreList[$Product['store_id']]['name'] ?></span>
                                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="controls">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="product-view-display">
                                                                    <span><?= $Product['has_quote_form'] == 1 ? 'Yes' : 'No' ?>
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="form-inner-label">Flat Size ( Inches )
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="product-view-display">
                                                                ...
                                                                <label class="form-inner-label">Finished Size ( Inches )
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="product-view-display">
