                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="name_french" id="name_french"
                              type="text" placeholder="French Name"
                            ...
                            <div class="col-md-8">
                              <div class="controls">
                                <input type="number" class="form-control" name="total_page"
                                  id="total_page" type="text" placeholder="Total Page"
                                  value='<?= isset($postData['total_page']) ? $postData['total_page'] : '' ?>'
                                  required>
                                <?= form_error('total_page') ?>
                              </div>
                            </div>
                          </div>
                        </div>
