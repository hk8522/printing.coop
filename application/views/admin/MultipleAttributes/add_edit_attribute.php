                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <input class="form-control" name="name" id="name" type="text" placeholder="Attribute Name"
                              value='<?=isset($postData['name']) ? $postData['name'] : ''?>' required>
                            <?=form_error('name')?>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-9">
                          <div class="controls">
                            <input class="form-control" name="name_french" id="name_french" type="text"
                              ...
                              value='<?=isset($postData['name_french']) ? $postData['name_french'] : ''?>' required>
                                ...
                                <div class="att-single">
                                  <div class="row">
                                    <div class="col-md-6">
                                      ...
                                      <input class="form-control" name="attribute_item_name[]" id="attribute_item_name"
                                        type="text" placeholder="Attribute Item" required value='<?=$val['item_name']?>'>
                                    </div>
                                    <div class="col-md-6">
                                      <label>French Attribute Item Name</label>
                                      <input class="form-control" name="item_name_french[]" id="item_name_french"
                                        type="text" placeholder="French Attribute Item" required
                                        value='<?=$val['item_name_french']?>'>
                                      <input class="form-control" name="attribute_item_id[]" id="attribute_item_id"
                                        type="hidden" maxlength="50" value="<?=$val['id']?>">
                                    </div>
                                  </div>
                                  <div class="add-new-btn">
                                    ...
                                    ?>
                                    <button class="btn-danger btn-remove" type="button" title="remove"
                              ...
                              <div class="att-single">
                                <div class="row">
                                  <div class="col-md-6">
                                    <label>Attribute Item Name</label>
                                    <input class="form-control" name="attribute_item_name[]" id="attribute_item_name"
                                      type="text" placeholder="Attribute Item" required>
                                  </div>
                                  <div class="col-md-6">
                                    <label>French Attribute Item Name</label>
                                    <input class="form-control" name="item_name_french[]" id="item_name_french"
                                      type="text" placeholder="French Attribute Item" required>
                                    <input class="form-control" name="attribute_item_id[]" id="attribute_item_id"
                                      type="hidden" maxlength="50" value="">
                                  </div>
                                </div>
                                <div class="add-new-btn">
