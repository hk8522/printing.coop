                                                      ...
                                                      <div class="row">
                                                          <?php
                                                            ...
                                                            foreach ($languages as $key => $language) {
                                                              ...
                                                              <div class="col-md-6">
                                                                  <label class="span2">
                                                                    <input name="languages[]"  type="checkbox" value="<?= $language['name'] ?>" <?= $checked ?>> <?= $language['name']  ?>
                                                                 </label>
                                                              </div>
                                                              <?php
                                                            }
                                                      ...
                                                      <div class="row">
                                                          <?php
                                                            ...
                                                            foreach ($currencies as $key => $currency) {
                                                              ...
                                                              <div class="col-md-6">
                                                                  <label class="span2">
                                                                    <input name="currencies[]" type="checkbox" value="<?= $currency['code'] ?>" <?= $checked ?>> <?= $currency['name']  ?>
                                                                  </label>
                                                              </div>
                                                              <?php
                                                            }
                                                  ...
                                                  <div class="controls">
                                                           ...
                                                           if ($imageurl) {
                                                             ...
                                                             <?php
                                                                                 ...
                                                                                 ?>
                                                                                  <input name="logo_image_french" value="<?= $old_image ?>" type="hidden">
                                                                              </div>
                                                                        </div>
                                                  <div class="entry input-group col-xs-12" style="margin-bottom:15px;">
                         ...
                         ?>
                                                           ...
                                                           if ($imageurl) {
                                                             ...
                                                             <?php
                                                                                 ...
                                                                                 ?>
                                                                                  <input name="old_favicon" value="<?= $old_favicon ?>" type="hidden">
                                                                              </div>
                                                                        </div>
                                                  <div class="entry input-group col-xs-12" style="margin-bottom:15px;">
                ...
                $old_french_favicon =isset($configrations['french_favicon']) ? $configrations['french_favicon'] : '';
                                                           ...
                                                           if ($imageurl) {
                                                             ...
                                                             <?php
                                                                                 ...
                                                                                 ?>
                                                                                  <input name="old_french_favicon" value="<?= $old_french_favicon ?>" type="hidden">
                                                                              </div>
                                                                        </div>
                                                  <div class="entry input-group col-xs-12" style="margin-bottom:15px;">
