                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="table-filter-inner control-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="table-filter-fields">
                                            <button class="" type="button" id="btnsubmit"
                                                onclick="AddSingleProduct()">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$('#category_id').on('change', function(e) {
    ...
    $.ajax({
        ...
        contentType: false,
        processData: false,
        url: '<?= $BASE_URL ?>admin/Ajax/getSubCategoryAndProductDropDownListByAjax/' + category_id,
...
$('#sub_category_id').on('change', function(e) {
    ...
    url = '<?= $BASE_URL ?>admin/Ajax/getActiveProductDropDownListByAjax/' + sub_category_id;
...
$('#coupon_code').on('change', function(e) {
    ...
    $.ajax({
        ...
        contentType: false,
        processData: false,
        url: '<?= $BASE_URL ?>admin/Orders/applyCode/' + coupon_code,
        success: function(data) {
            var json = JSON.parse(data);
            $('#loader-img').hide();
...
$('#email').on('change', function(e) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: '<?= $BASE_URL ?>admin/Orders/PrefferedCustomerDiscount/',
        data: {
            'email': email
        },
        success: function(data) {
...
$('.shipping_method_formate').on('change', function(e) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: '<?= $BASE_URL ?>admin/Orders/shippingMethodFormate',
        data: {
            'shipping_method_formate': shipping_method_formate
        },
        success: function(data) {
            var json = JSON.parse(data);
            $('#loader-img').hide();
...
function AddSingleProduct() {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'html',
        url: '<?= $BASE_URL ?>admin/Orders/AddSingleProduct/' + product_id,
        cache: false,
        contentType: false,
        processData: false,
        success: function(data) {
...
function getSingleProduct() {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'html',
        url: '<?= $BASE_URL ?>admin/Orders/getProductList/',
        cache: false,
        contentType: false,
        processData: false,
        success: function(data) {
...
function removeProduct(product_id_key) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'html',
        url: '<?= $BASE_URL ?>admin/Orders/RemoveSingleProduct/' + product_id_key,
        cache: false,
        contentType: false,
        processData: false,
        success: function(data) {
...
function showQuantity(product_id_key) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: '<?= $BASE_URL?>admin/Orders/GetQuantity',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
...
function getSizeOptions(product_id, make_a_default_qty_id, product_id_key) {
    ...
    $.ajax({
        type: 'GET',
        dataType: 'html',
        url: '<?= $BASE_URL?>admin/Orders/getSizeOptions/' + product_id + '/' + make_a_default_qty_id + '/' +
            product_id_key,
        cache: false,
        contentType: false,
        processData: false,
...
function uploadData(formdata, product_id_key) {
    $.ajax({
        url: '<?= $BASE_URL?>admin/Orders/uploadImage',
        type: 'post',
        data: formdata,
        contentType: false,
        processData: false,
...
function update_cumment(skey, product_id, product_key_id) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: '<?= $BASE_URL?>admin/Orders/updateCumment',
        data: ({
            'cumment': cumment,
...
function delete_image(skey, product_id, product_key_id) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: '<?= $BASE_URL?>admin/Orders/deleteImage',
        data: ({
            'location': location,
            'product_id': product_id,
            'product_key_id': product_key_id,
