                        ...
                        <div class="form-body">
                            <div class="col-12 px-0">
                                <div class="row align-items-end">
                                    <div class="col-md-5 col-ms-6 col-6">
    ...
    $(document).ready(function () {
        $('#orders-grid').kendoGrid({
            ...
            columns: [{
                ...
                template: '#=Number(sub_total_amount).toFixed(2)#',
                headerAttributes: { style: "text-align:center" },
                attributes: { style: "text-align:center" },
            }, {
                title: 'Preffered Customer Discount',
                template: '#=preffered_customer_discount == 0 ? "-" : Number(preffered_customer_discount).toFixed(2)#',
                headerAttributes: { style: "text-align:center" },
                attributes: { style: "text-align:center" },
            }, {
                title: 'Coupon Discount',
                template: '#=coupon_discount_amount == 0 ? "-" : Number(coupon_discount_amount).toFixed(2)#',
                headerAttributes: { style: "text-align:center" },
                attributes: { style: "text-align:center" },
            }, {
                title: 'Shipping Fee',
                template: '#=delivery_charge == 0 ? "-" : Number(delivery_charge).toFixed(2)#',
                headerAttributes: { style: "text-align:center" },
                attributes: { style: "text-align:center" },
            }, {
