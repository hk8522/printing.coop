                  ...
                  <div class="form-role-area">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="phone" id="phone" type="text" placeholder="Phone"
                              value="<?=isset($postData['phone']) ? $postData['phone'] : ''?>">
                            <?=form_error('phone')?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="url" id="url" type="url" placeholder="Url"
                              value="<?=isset($postData['url']) ? $postData['url'] : ''?>">
                            <?=form_error('url')?>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <textarea name="address"
                              id="address"><?=isset($postData['address']) ? $postData['address'] : ''?></textarea>
                            <?=form_error('address')?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="order_id_prefix" id="order_id_prefix" type="text"
                              placeholder="Email"
                              value="<?=isset($postData['order_id_prefix']) ? $postData['order_id_prefix'] : ''?>">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <select name="show_language_translation" class="form-control">
                              <option value="1" <?=$postData['show_language_translation'] == 1 ? 'selected' : ''?>>Yes
                              </option>
                              <option value="0" <?=$postData['show_language_translation'] == 0 ? 'selected' : ''?>>No
                              </option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <select name="show_all_categories" class="form-control">
                              <option value="1" <?=$postData['show_all_categories'] == 1 ? 'selected' : ''?>>Yes
                              </option>
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="from_email" id="from_email" type="email"
                              placeholder="Email"
                              value="<?=isset($postData['from_email']) ? $postData['from_email'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="admin_email1" id="admin_email1" type="email"
                              placeholder="Email"
                              value="<?=isset($postData['admin_email1']) ? $postData['admin_email1'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="admin_email2" id="admin_email2" type="email"
                              placeholder="Email"
                              value="<?=isset($postData['admin_email2']) ? $postData['admin_email2'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="admin_email3" id="admin_email3" type="email"
                              placeholder="Email"
                              value="<?=isset($postData['admin_email3']) ? $postData['admin_email3'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="clover_sandbox_api_key" id="clover_sandbox_api_key"
                              type="text"
                              value="<?=isset($postData['clover_sandbox_api_key']) ? $postData['clover_sandbox_api_key'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="clover_sandbox_secret" id="clover_sandbox_secret"
                              type="text"
                              value="<?=isset($postData['clover_sandbox_secret']) ? $postData['clover_sandbox_secret'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="clover_api_key" id="clover_api_key" type="text"
                              value="<?=isset($postData['clover_api_key']) ? $postData['clover_api_key'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="clover_secret" id="clover_secret" type="text"
                              value="<?=isset($postData['clover_secret']) ? $postData['clover_secret'] : ''?>">
                          ...
                          <div class="controls">
                            <select name="paypal_payment_mode" class="form-control">
                              <option value="sandbox"
                                <?=$postData['paypal_payment_mode'] == 'sandbox' ? 'selected' : ''?>>Sandbox</option>
                              <option value="live" <?=$postData['paypal_payment_mode'] == 'live' ? 'selected' : ''?>>
                                Live</option>
                            </select>
                          </div>
                        </div>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        <div class="col-md-4">
                          <label class="span2" for="paypal_sandbox_business_email">Sandbox Payment Paypal Business
                            Email</label>
                        </div>
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="paypal_sandbox_business_email"
                              id="paypal_sandbox_business_email" type="email" placeholder="Email"
                              value="<?=isset($postData['paypal_sandbox_business_email']) ? $postData['paypal_sandbox_business_email'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <input class="form-control" name="paypal_business_email" id="paypal_business_email"
                              type="email" placeholder="Email"
                              value="<?=isset($postData['paypal_business_email']) ? $postData['paypal_business_email'] : ''?>">
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <textarea name="email_footer_line"
                              id="content"><?=isset($postData['email_footer_line']) ? $postData['email_footer_line'] : ''?></textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="entry input-group col-xs-12" style="margin-bottom:15px;">
                            <input class="btn btn-primary" name="logo_image" type="file"
                              accept="image/x-png,image/gif,image/jpeg" id="fileUpload-1">
                            &nbsp;&nbsp;
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <textarea name="invoice_pdf_company"
                              id="content1"><?=isset($postData['invoice_pdf_company']) ? $postData['invoice_pdf_company'] : ''?></textarea>
                    ...
                    <div class="control-group info">
                      <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                          <div class="controls">
                            <textarea name="order_pdf_company"
                              id="content2"><?=isset($postData['order_pdf_company']) ? $postData['order_pdf_company'] : ''?></textarea>
                    ...
                    <div class="control-group info">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="entry input-group col-xs-12" style="margin-bottom:15px;">
                            <input class="btn btn-primary" name="pdf_template_logo" type="file"
                              accept="image/x-png,image/gif,image/jpeg" id="fileUpload-2">
                            &nbsp;&nbsp;
                          </div>
                        </div>
                      </div>
