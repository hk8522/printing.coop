        ...
        <tr>
            ...
            <td style="width: 50%;">
                <div style="text-align: right;">
                    ...
                    <h2 style="margin: 0px; font-size: 24px; font-weight: 600; color: #000;">Réf. : F-00<?= $orderData['id'] ?></h2>
                    <p style="margin: 15px 0px 0px 0px; font-size: 18px; font-weight: 400; color: #000;">Réf. ordre: <?= ORDER_ID_PREFIX_FRENCH.$orderData['id']?> (GAL inc.) / <?= date('d/m/Y',strtotime($orderData['created'])) ?></p>
                </div>
            </td>
        </tr>
    </table>
