    ...
    <body style="margin: 0px; padding: 0px;">
            ...
            <tr>
                ...
                <td style="width: 50%;">
                    <div style="text-align: right;">
                        ...
                        <h2 style="margin: 0px; font-size: 24px; font-weight: 600; color: #000;">Ref. :
                            F-00<?php echo $orderData['id'];?></h2>
                        <p style="margin: 15px 0px 0px 0px; font-size: 18px; font-weight: 400; color: #000;">Ref. order:
                            <?php echo $orderData['order_id']?> (GAL inc.) /
                            <?php echo date('d/m/Y',strtotime($orderData['created']))?></p>
                    </div>
                </td>
            </tr>
        </table>
                ...
                <td style="width: 50%;">
                    <div>
                        <p style="margin: 0px 0px 0px 0px; font-size: 16px; font-weight: 400; color: #000;">
                            <b><?php echo ucfirst($orderData['billing_name']);?></b></p>
                        <p style="margin: 0px 0px 0px 0px; font-size: 16px; font-weight: 400; color: #000;">
                            <?php echo $orderData['billing_address'];?></p>
                        ...
                        <p style="margin: 0px 0px 0px 0px; font-size: 16px; font-weight: 400; color: #000;">Phone:
                            <?php echo ucfirst($orderData['billing_mobile']);?></p>
                        <p style="margin: 0px 0px 0px 0px; font-size: 16px; font-weight: 400; color: #000;">Email:
                            <?php echo ucfirst($orderData['email']);?></p>
                    </div>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td style="width: 20%;">
                    <div style="text-align: center;">
                        <p style="margin: 0px 0px 10px 0px; font-size: 16px; font-weight: 400; color: #000;"><b>Billing
                                date</b></p>
                        <p style="margin: 0px 0px 0px 0px; font-size: 16px; font-weight: 400; color: #000;">
                            <?php echo date('d/m/Y',strtotime($orderData['created']))?></p>
                    </div>
                ...
                <td style="width: 20%;">
                    <div style="text-align: center;">
                        <p style="margin: 0px 0px 10px 0px; font-size: 16px; font-weight: 400; color: #000;"><b>Ref.
                                customer</b></p>
                ...
                <td style="width: 20%;">
                    <div style="text-align: center;">
                        <p style="margin: 0px 0px 10px 0px; font-size: 16px; font-weight: 400; color: #000;"><b>Customer
                                code</b></p>
                ...
                <td style="width: 20%;">
                    <div style="text-align: center;">
                        <p style="margin: 0px 0px 10px 0px; font-size: 16px; font-weight: 400; color: #000;"><b>VAT
                                number</b></p>
        ...
        <table
            style="width: 100%;border: 2px solid #ff0000; text-align: left; border-collapse: collapse; margin-top: 20px;">
            <thead>
                <tr>
                    <th
                        style="background: #aad4ff; color: #000; vertical-align: middle;font-size: 16px; text-transform: capitalize; font-weight: 400; white-space: nowrap; padding: 10px 10px !important; border-right: 2px solid #ff0000;">
                        Designation</th>
            ...
            <tbody>
                ...
                <tr style="background-color: #fff; border-bottom: 1px dashed #ccc !important;">
                    <td
                        style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 10px 10px !important; border-bottom: 1px dashed #ccc; border-right: 2px solid #ff0000;">
                        <?php echo ucfirst($item['name'])?><br>
                        <?php
                if(!empty($product_width_length)){?>
                        <span><strong>Length(Inch):<?php echo $product_width_length['product_length'];?></strong>
                        </span>,
                       ...
                       if(!empty($product_depth_length_width)){?>
                        <span><strong>Length(Inch):<?php echo $product_depth_length_width['product_depth_length'];?></strong>
                        </span>,
                        ...
                        <span><strong>Page
                                Length(Inch):<?php echo $page_product_width_length['page_product_length'];?></strong>
                        </span>,
                        <span><strong>Page
                                Width(Inch):<?php echo $page_product_width_length['page_product_width'];?></strong>
                        </span>,
                        ...
                        <span><strong>Pages:<?php echo $page_product_width_length['page_product_total_page'];?></strong>
                        </span>
                        <?php
                        }?>
                        <?php
                        ...
                        <span><strong><?php echo $multiple_attribute_name;?>:<?php echo $multiple_attribute_item_name;?></strong>
                        </span>
                        <?php
                                    }
                                }?>
                    ...
                    <td
                        style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 10px 10px !important; border-bottom: 1px dashed #ccc; border-right: 2px solid #ff0000;">
                        <?php echo $order_currency_currency_symbol.number_format($item['price'],2);?>
                    </td>
                    <td
                        style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 10px 10px !important; border-bottom: 1px dashed #ccc; border-right: 2px solid #ff0000;">
                        <?php
                    ...
                    <table style="width: 100%; text-align: left; border-collapse: collapse;">
                        <tbody>
                            <tr style="background-color: #fff;">
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important;">
                                    Subtotal:</td>
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important; text-align: right;">
                                    <?php echo $order_currency_currency_symbol."".number_format($orderData['sub_total_amount'],2);?>
                                </td>
                            </tr>
                            ...
                            <tr style="background-color: #fff;">
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important;">
                                    Preffered Customer Discount:</td>
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important; text-align: right;">
                                    <?php echo '-'.$order_currency_currency_symbol.number_format($orderData['preffered_customer_discount'],2);?>
                                </td>
                            </tr>
                            <?php
                        }?>
                            ...
                            <tr style="background-color: #fff;">
                                ...
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important; text-align: right;">
                                    <?php echo '-'.$order_currency_currency_symbol.number_format($orderData['coupon_discount_amount'],2);?>
                                </td>
                            </tr>
                            <?php
                        }?>
                            ...
                            <tr style="background-color: #fff;">
                                ...
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important; text-align: right;">
                                    <?php echo $order_currency_currency_symbol.number_format($orderData['delivery_charge'],2);?>
                                </td>
                            </tr>
                            <?php
                        }?>
                            ...
                            <tr style="background-color: #fff;">
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important;">
                                    <?php echo $salesTaxRatesProvinces_Data['type']?>
                                    <?php echo number_format($salesTaxRatesProvinces_Data['total_tax_rate'],2);?>%:</td>
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 400; padding: 5px 5px !important; text-align: right;"><?php
    echo $order_currency_currency_symbol.number_format($orderData['total_sales_tax'],2);?></td>
                            ...
                            <tr style="background-color: #fff;">
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 600; padding: 5px 5px !important; background: #e7e7e7;">
                                    Total:</td>
                                <td
                                    style="color: #000; vertical-align: middle; font-size: 16px; font-weight: 600; padding: 5px 5px !important; background: #e7e7e7; text-align: right;"><?php
