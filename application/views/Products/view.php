                    ...
                    <div class="shop-product-detail-section">
                        <div class="shop-product-detail">
                            ...
                            <div class="wishlist-area">
                                <a data-toggle="tooltip" title="Add to wishlist" href="javascript:void(0)" onclick="addProductWishList('<?= $Product['id']?>')">
                                            ...
                                            <div class="col-md-12 col-md-12 col-md-8">
                                                ...
                                                <?php if ($Product['add_length_width'] == 1) {?>
                                                    <div class="single-review">
                                                        <label><?= $language_name == 'French' ? 'Longueur (pouces)' : 'Length (Inch)'?><span class="required">*</span></label>
                                                    ...
                                                    <div class="single-review">
                                                        <label><?= $language_name == 'French' ? 'Largeur (pouces)' : 'Width (Inch)'?><span class="required">*</span></label>
                                                    ...
                                                    <?php if ($Product['length_width_quantity_show'] == 1) {?>
                                                        <div class="single-review">
                                                            ...
                                                            <?php if ($Product['length_width_pages_type'] == 'input') {?>
                                                                <input type="number" name="product_total_page" id="product_total_page" required  onkeypress="javascript:return isNumber(event)" value="<?= $Product['length_width_min_quantity']?>" onkeypress="javascript:return isNumber(event)">
                                                            <?php } else {?>
                                                ...
                                                <?php if ($Product['page_add_length_width'] == 1) {?>
                                                    ...
                                                    <?php if ($Product['page_length_width_sheets_show'] == 1) {?>
                                                        <div class="single-review">
                                                            <label><?= $language_name == 'French' ? 'Feuille par bloc' : 'Sheet Per Pad'?><span class="required">*</span></label>
                                                            <?php if ($Product['page_length_width_sheets_type'] == 'input') {?>
                                                                <input type="text" name="page_product_total_sheets" id="page_product_total_sheets" required value="1" onkeypress="javascript:return isNumber(event)" >
                                                            <?php } else {?>
                                                                <select name="page_product_total_sheets" required id="page_product_total_sheets">
                                                                    <option value=""><?= $language_name == 'French' ? 'Sélectionner une feuille par bloc' : 'Select Sheet per pad'?></option>
                                                                    <?php foreach($ProductSheets as $Sheets) {?>
                                                                        <option value="<?= $Sheets['name']?>"><?= $language_name == 'French' ? $Sheets['name_french'] : $Sheets['name']?></option>
                                                                    <?php }?>
                                                                </select>
                                                            <?php }?>
                                                        ...
                                                        <div class="single-review">
                                                            ...
                                                            <?php } else { ?>
                                                                <select name="page_product_total_quantity" required id="page_product_total_quantity">
                                                                    ...
                                                                    <?php foreach($pageQuantity as $Quantity) {?>
                                                                        <option value="<?= $Quantity['name']?>"><?= $language_name == 'French' ? $Quantity['name_french'] : $Quantity['name']?></option>
                                                                    <?php }?>
                                                                </select>
                                                            <?php }?>
                                                ...
                                                <?php if ($Product['depth_add_length_width'] == 1) {?>
                                                    ...
                                                    <div class="single-review">
                                                        <label><?= $language_name == 'French' ? 'Profondeur (pouces)' : 'Depth (Inch)'?>  <span class="required">*</span></label>
                                                    ...
                                                    <?php if ($Product['depth_width_length_quantity_show'] == 1) {?>
                                                        <div class="single-review">
                                                            ...
                                                            <?php if ($Product['depth_width_length_type'] == 'input') { ?>
                                                                <input type="text" name="product_depth_total_page" id="product_depth_total_page" required value="<?= $Product['depth_min_quantity']?>" onkeypress="javascript:return isNumber(event)" >
                                                            <?php } else { ?>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="single-review">
                                                        <label><?= $language_name == 'French' ? $val['data']['attribute_name_french'] : $val['data']['attribute_name']?><span class="required">*</span></label>
                                                        <?php $items = $val['items'];?>
                                                        <?php if (!empty($items)) {?>
                                                            <select name="attribute_id_<?= $key?>" required <?php if ($i > 1) {echo 'disabled';}?> onchange="showAttribute(<?= $i?>,'<?= $i + 1?>')" id="attribute_id_<?= $i?>">
                                                                <option value=""><?= $language_name == 'French' ? 'Choisis une option...':'Choose an option...'?> </option>
                                                                ...
                                                                ?>
                                                                    <option value="<?= $subval['attribute_item_id']?>"><?= $language_name == 'French' ? $subval['item_name_french'].$extra_price : $subval['item_name'].$extra_price?></option>
                                                                <?php }?>
                                                            </select>
                                                        <?php $i++;
                                                        }?>
                                                ...
                                                <?php if ($Product['recto_verso'] == 1) {?>
                                                    <div class="single-review">
                                                        ...
                                                        <select name="recto_verso" required id="attribute_id_<?= $i?>" <?php if ($i > 1) {echo 'disabled';}?> onchange="showAttribute(<?= $i?>,'<?= $i + 1?>')">
                                                            <option value=""><?= $language_name == 'French' ? 'Choisis une option...':'Choose an option...'?></option>
                                                ...
                                                <?php if ($Product['votre_text'] == 1) {?>
                                                    <div class="single-review">
                                                        <label><?= $language_name == 'French' ? 'Votre TEXTE - Votre TEXTE' : 'Your TEXT - Votre TEXT'?><span class="required">*</span></label>
                                            ...
                                            <div class="col-6 col-md-6">
                                                <div class="shop-product-price">
                                                    <span>
                                                        ...
                                                        <font class="new-price"><?= $product_price_currency_symbol.'<span id="total-price">'.$Product[$product_price_currency].'</span>'?></font>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6">
                                    ...
                                    <?php if ($website_store_id != 5) { ?>
                                        <div class="file-upload-section">
                                            <div class="file-upload-area">
                                                ...
                                                <span class="info-span"><?= $language_name == 'French' ? "Soumettre et télécharger le fichier (Taille autorisée par fichier: 250 Mo. Type de fichier autorisé: pdf)" : "Submit and Upload File (Allow size per file: 250 Mb. Allow file type:pdf)"?></span>
                                                <div class="upload-file upload-area" id="uploadfile">
                                                    <span class="file-btn"><?= $language_name == 'French' ? 'Soumettre le téléchargement' : 'Submit Upload'?></span>
                                                    <span id="file-drop"><?= $language_name == 'French' ? 'Glisser-déposer des fichiers' : 'Drag & Drop Files'?></span>
                                                </div>
                                            </div>
                        ...
                        <div class="tabcontent-inner">
                            ...
                            <div class="universal-dark-info">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col"><?= $language_name == 'French' ? 'Dimensions finales' : 'Final Dimensions'?></th>
                                            <th scope="col"><?= $language_name == 'French' ? 'La description' : 'Description'?></th>
                                            <th scope="col"><?= $language_name == 'French' ? 'Télécharger' : 'Download'?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<?php if ($language_name == 'French') { ?>
    <script src="<?= $BASE_URL?>assets/file-upload/script-franch.js" type="text/javascript"></script>
<?php } else {?>
            ...
            success: function (data) {
                ...
                if (json.success == 1) {
                    if (json.sizeoprions == '0') {
                        ...
                        $("#SizeOptions").html(json.sizeoprions);
                    }
                    $("#total-price").html(json.price);
                }
            }
