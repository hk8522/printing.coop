						    ...
						    <form method="post" id="cardFrom">
                             ...
                             <div class="product-fields">
                                <div class="row">
									...
									<input type="hidden" name="page_length_width_sheets_show" value="<?php echo $Product['page_length_width_sheets_show'];?>">
...
<span class="required">*</span></label>
								...
								<?php if($Product['page_length_width_pages_show']==1){?>
									...
									<div class="single-review">
										...
										<?php }else{?>
										 <select name="page_product_total_sheets" required id="page_product_total_sheets">
							                ...
							                if($language_name=='French'){ ?>
							                  <option value="">
										      Sélectionner une feuille par bloc
										   </option>
										   
							                <?php }else{ ?>
							                <option value="">
										       Select Sheet per pad
										    </option>
							                <?php 
							                }?>
									...
									<?php 
										...
										<?php 
										if($Product['page_length_width_quantity_show']==1){  
										?>		
											<div class="single-review">
												<label><?php 
													if($language_name=='French'){ ?>
												...
												<?php 
												 if($Product['page_length_width_quantity_type']=='input'){
												?>	  
							...
							<?php if($Product['depth_width_length_quantity_show']==1){?>		
									<div class="single-review">
										...
										<input type="text" name="product_depth_total_page" id="product_depth_total_page" required value="<?php echo $Product['depth_min_quantity']?>" onkeypress="javascript:return isNumber(event)" >
                                ...
                                <div class="file-upload-area">
								    <input type="file" name="file" id="file" style="display:none" accept="application/pdf">
                                     <span class="info-span"><?php 
							                if($language_name=='French'){ ?>
							                  Soumettre et télécharger le fichier (Taille autorisée par fichier: 250 Mo. Type de fichier autorisé: pdf)

							                <?php }else{ ?>
							                  Submit and Upload File (Allow size per file: 250 Mb. Allow file type:pdf)
							                <?php 
							                }?></span>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    if($language_name=='French'){        
    ?>
        <script src="<?php echo $BASE_URL?>assets/file-upload/script-franch.js" type="text/javascript"></script>
    <?php 
    }else{?>
