...
<script>
    ...
    $("#page_product_width, #page_product_length, #page_product_total_page, #page_product_total_sheets, #page_length_width_color, #page_product_total_quantity" ).change(function() {
        getPageLengthWidthPrice();
    });

    $("#product_depth_width, #product_depth_total_page, #product_depth_length, #product_depth, #depth_color" ).change(function() {
