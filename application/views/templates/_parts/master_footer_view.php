                    ...
                    <div class="newsletter-single-inner">
                        <div class="newsletter-content">
                            <div class="universal-light-title">
                                <span><?= ($language_name == 'French') ? 'Bulletin' : 'Newsletter' ?></span>
                            </div>
                            <div class="universal-light-info">
                                <span><?= ($language_name == 'French') ? 'Reste en contact' : 'Stay in Touch' ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="fotter-main-section-inner">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="fotter-single">
                        <div class="universal-small-dark-title">
                            <span><?= ($language_name == 'French') ? 'ENTRER EN CONTACT' : 'GET IN TOUCH' ?></span>
                        </div>
                    ...
                    <div class="bootom-footer-single">
                        <div class="copywrite-text">
                            <span>Copyright © <?=date('Y')?>
                                <?=$language_name == 'French' ? $configrations['copy_right_french'] : $configrations['copy_right']?></span>
                        </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (json.total_item == 0) {
                    $('#shoping-cart-container').html(
                        '<div class="text-center"><h4 class="lead">Shopping Cart Is Empty</h4></div>');
            ...
            success: function(data) {
                ...
                if (status == 1) {
                    if (json.total_item == 0) {
                        if (language_name == 'French') {
                            $('#shoping-cart-container').html(
                                "<div class='text-center'><h4 class='lead'>Le panier d'achat est vide</h4></div>"
                            );
                        } else {
                            $('#shoping-cart-container').html(
                                '<div class="text-center"><h4 class="lead">Shopping Cart Is Empty</h4></div>'
                ...
                success: function(data) {
                    ...
                    if (status == 1) {
                        ...
                        if (loginId != '') {
                            ...
                            setTimeout(function() {
                                window.location.href = '<?=$BASE_URL?>/Logins'
                            }, 2000);
                        }
                    } else {
