                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<?= $BASE_URL_ADMIN ?>Dashboards/logout" class="btn btn-warning btn-flat">Logout</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
...
<div id="loader-img"><div id="loader-img-inner"><img src="<?= $BASE_URL ?>assets/images/loder.gif" width="100"></div></div>
