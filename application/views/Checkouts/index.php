                                                    ...
                                                    <div id="ck_signup_msg"></div>
                                                      <div class="single-review">
                                                          ...
                                                          <input type="hidden" name="signupOtp" id="ck_signupOtp" value="">
                                                            ...
                                                            <?= ($language_name == 'French') ? 'Renvoyer' : 'Resend'?></button>
                                                      </div>
                                                      <div class="next-register-fields" style="display:" id="signup-next">
                                                        <div class="single-review">
                                                            <label>
                                                            <?= ($language_name == 'French') ? 'Entrez le code:' : 'Resend'?></label>
                                                        ...
                                                        <div class="single-review">
                                                            <label>
                                                            <?= ($language_name == 'French') ? 'Prénom:' : 'First Name:'?></label>
                                                        ...
                                                        <div class="single-review">
                                                            <label>
                                                            <?= ($language_name == 'French') ? 'Nom de famille:' : 'Last Name:'?></label>
                                                        ...
                                                        <div class="single-review">
                                                            <label>
                                                            <?= ($language_name == 'French') ? 'Définir le mot de passe:' : 'Set Password:'?></label>
                                                        ...
                                                        <div class="single-review">
                                                            <label>
                                                            <?= ($language_name == 'French') ? 'Confirmez le mot de passe:' : 'Confirm Password:'?></label>
                                                      ...
                                                      <div class="login-btn">
                                                          ...
                                                          <?= ($language_name == 'French') ? 'S\'inscrire' : 'Signup'?></button>
                                                      </div>
                                                  </div>
                                              </label>
                                            </form>
                                              ...
                                              <label id="login-signup">
                                                  <div class="shipping-form" >
                                                    <div id="ck_login_msg"></div>
                                                      ...
                                                      <div class="single-review">
                                                          <label>
                                                          <?= ($language_name == 'French') ? 'Mot de passe:' : 'Password:'?></label>
                                                      ...
                                                      <div class="login-btn">
                                                          ...
                                                          <?= ($language_name == 'French') ? 'S\'identifier' : 'Login'?></button>
                                                      </div>
                                                  </div>
                                              </label>
                                            </form>
                              ...
                              <div id="collapse2" class="collapse show" aria-labelledby="heading2" data-parent="#accordion">
                                ...
                                <?php echo $list['cityName'];?>,<?php echo $list['StateName'];?>,<?php echo $list['CountryName'];?> - <strong><?php echo $list['pin_code'];?></strong></span>
                                                  ...
                                                  <?php } ?>
                                                      ...
                                                      <?= ($language_name == 'French') ? 'Enregistrer et livrer ici' : 'Save and Deliver here'?></button>
                                                </div>
                                              </div>
                                          ...
                                          <div class="checkout-addresss for-cus-new-add">
                                              <label id="new-address">
                                                  ...
                                                  <?= ($language_name == 'French') ? 'Nouvelle adresse' : 'New Address'?></span>
                                              </label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                          <div class="address-type">
                                                              <div class="single-review">
                                                                  <label>
                                                                  <?= ($language_name == 'French') ? 'Type d\'adresse' : 'Address Type'?></label>
                                                              </div>
                                                              <div class="row">
                                                                  <div class="col-md-6">
                                          ...
                                          <div class="shipping-metthod-single">
                                              <label>
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-3 col-lg-3 col-xl-3">
                                                          <span>
                                                          <?= ($language_name == 'French') ? 'Postes Canada' : 'Canada Post'?></span>
                                                      </div>
                                                  </div>
                                              </label>
                                          </div>
                                          ...
                                          <div class="shipping-metthod-single">
                                              <label>
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-3 col-lg-3 col-xl-3">
                                                          <span>
                                                          <?= ($language_name == 'French') ? 'Vaisseau amiral' : 'FlagShip'?></span>
                                                      </div>
                                                  </div>
                                              </label>
                                          </div>
                                              ...
                                              <label>
                                                  ...
                                                  <div class="row">
                                                      <div class="col-md-12 col-lg-12 col-xl-2">
                                                          <strong>
                                                          <?= ($language_name == 'French') ? 'Livraison gratuite' : 'Free Delivery'?></strong>
                                                      </div>
                                                      ...
                                                      <div class="col-md-4 col-lg-5 col-xl-3">
                                                          <span>
                                                          <?= ($language_name == 'French') ? 'Ramassage en magasin' : 'Pickup In Store'?></span>
                                                      </div>
                                                  </div>
                                              </label>
                                          </div>
                                              ...
                                              <div id="collapsePay3" class="collapse show" aria-labelledby="headingPay3" data-parent="#accordion1" style="">
                                                  <div class="payment-option">
                                                      <div class="order-confirm-text">
                                                          <span>
                                                          <?= ($language_name == 'French') ? 'Vous serez redirigé vers la page Paypal' : 'You\'ll be redirected to Paypal page'?></span>
                                                      </div>
                                                  </div>
                                                  </div>
                                              </div>
...
<!-- POS CHECKOUT END -->
                                              ...
                                              <div class="row align-items-center">
                                               <div class="col-md-6 text-left">
                                                      <div class="product-subtotal text-left">
                                                          <span>
                                                            <?= ($language_name == 'French') ? 'Combien d\'ensembles:' : 'How many sets:'?><?php echo $items['quantity'];?></span>
                                                      </div>
                                                  </div>
    ...
    <?php if (!empty($product_width_length)) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong><?= ($language_name == 'French') ? 'Longueur(pouces)' : 'Length(Inch)'?>: <?php echo $product_width_length['product_length'];?></strong> </span>
                                    </div>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong> <?= ($language_name == 'French') ? 'Largeur (pouces)' : 'Width(Inch)'?>: <?php echo $product_width_length['product_width'];?></strong> </span>
                                    </div>
                            ...
                            <?php if (!empty($product_width_length['product_total_page'])) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong> <?= ($language_name == 'French') ? 'Quantité' : 'Quantity'?>: <?php echo $product_width_length['product_total_page'];?></strong> </span>
                                    </div>
                            <?php
                            }?>
                                <?php
                                ...
                                <?php if (!empty($product_depth_length_width)) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong><?= ($language_name == 'French') ? 'Longueur (pouces)' : 'Length(Inch)'?>: <?php echo $product_depth_length_width['product_depth_length'];?></strong> </span>
                                    </div>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong> <?= ($language_name == 'French') ? 'Largeur (pouces)' : 'Width(Inch)'?>: <?php echo $product_depth_length_width['product_depth_width'];?></strong> </span>
                                    </div>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong> <?= ($language_name == 'French') ? 'Profondeur (pouces)' : 'Depth(Inch)'?>: <?php echo $product_depth_length_width['product_depth'];?></strong> </span>
                                    </div>
                            ...
                            <?php if (!empty($product_depth_length_width['product_depth_total_page'])) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong> <?= ($language_name == 'French') ? 'Quantité' : 'Quantity'?>: <?php echo $product_depth_length_width['product_depth_total_page'];?></strong> </span>
                                    </div>
                            <?php
                            }?>
                       <?php
                                ...
                                <?php if (!empty($page_product_width_length)) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong><?= ($language_name == 'French') ? 'Longueur (pouces)' : 'Length(Inch)'?>: <?php echo $page_product_width_length['page_product_length'];?></strong> </span>
                                    </div>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong><?= ($language_name == 'French') ? 'Largeur(pouces)' : 'Width(Inch)'?>: <?php echo $page_product_width_length['page_product_width'];?></strong> </span>
                                    </div>
                         ...
                         <?php
                            if (!empty($product_size)) {
                                ...
                                if ($label_qty) { ?>
                                   <div class="col-md-12 col-lg-6 col-xl-6">
                                            <span><strong><?= ($language_name == 'French') ? 'Quantité' : 'Quantity'?> : <?php echo $label_qty;?></strong> </span>
                                    </div>
                                <?php
                                }?>
                                ...
                                if ($size_name) { ?>
                                    <div class="col-md-12 col-lg-6 col-xl-6">
                                        <span><strong><?= ($language_name == 'French') ? 'Taille' : 'Size'?>: <?php echo $size_name;?></strong> </span>
                                    </div>
                                <?php
                                }?>
                        ...
                        echo 'Recto/Verso:'.$recto_verso;
                                ...
                                <?php if (!empty($votre_text)) {?>
                                   <div class="col-md-12 col-lg-12 col-xl-6">
                                            <span><strong>
                                                <?= ($language_name == 'French') ? 'Votre TEXTE - Votre TEXTE' : 'Your TEXT - Votre TEXT'?>: <?php echo $votre_text?></strong> </span>
                                    </div>
                          ...
                          <div class="cart-total-area">
                              <div class="universal-dark-title">
                                  <span>
                                  <?= ($language_name == 'French') ? 'Totaux du panier' : 'Cart Totals'?></span>
                              </div>
                              <div class="single-cart-total">
                                  <div class="row">
                                      <div class="col-5 col-md-6">
                                          <strong>
                                          <?= ($language_name == 'French') ? 'Sous-total du panier' : 'Cart Subtotal'?></strong>
                                      </div>
                            ...
                            ?>
                              <div class="single-cart-total">
                                  <div class="row">
                                      <div class="col-5 col-md-6">
                                          <strong>
                                          <?= ($language_name == 'French') ? 'Remise client privilégiée' : 'Preffered Customer Discount'?></strong>
                                      </div>
                                      <div class="col-7 col-md-6">
                                          <strong>
                                           <?php
                            ...
                            <div class="single-cart-total">
                                <div class="row">
                                    <div class="col-5 col-md-6">
                                        <strong>
                                        <?= ($language_name == 'French') ? 'Remise de coupon' : 'Coupon Discount'?></strong>
                                    </div>
                                    <div class="col-7 col-md-6">
                                        <span><?php
                            ...
                            <?php }?>
                              <div class="single-cart-total">
                                  <div class="row">
                                      <div class="col-5 col-md-6">
                                          <strong>
                                          <?= ($language_name == 'French') ? 'Appliquer' : 'Apply'?>Shipping Method</strong>
                                      </div>
                                      <div class="col-7 col-md-6">
