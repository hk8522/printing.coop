...
?>
<div class="service-section universal-spacing" style="background-image: url(<?= $imageUrl ?>)">
    <div class="container">
        <div class="trend-section-inner">
            <div class="universal-light-title">
              <span><?php
                if ($language_name == 'French') {
                    echo $section_3['name_french'] ?? '';
                } else{
                    echo $section_3['name'] ?? '';
                } ?></span>
            </div>
            <div class="universal-light-info">
              <span><?php if ($language_name == 'French') {
                    echo $section_3['description_french'] ?? '';
                } else{
                    ...
                    foreach ($allServices as $key => $service) {
                      ...
                      ?>
                          <div class="col-6 col-md-4 col-lg-2 col-xl-2">
                                ...
                                ?>
                              <div class="all-services-content" style="background-image: url(<?= $imageurl ?>)">
