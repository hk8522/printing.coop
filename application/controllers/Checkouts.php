...
class Checkouts extends Public_Controller
{
    ...
    public function PayPalSuccessResponse($order_id = null)
    {
        $this->load->model('ProductOrder_Model');
        $orderData = array();
        $this->data['page_title'] = 'Order Details';
    ...
    public function defaultPayPalIPNResponse()
    {
        exit();
    }
    public function PayPalIPNResponse($order_id = null)
    {
        $this->load->model('Store_Model');
        $this->load->model('ProductOrder_Model');
    ...
    public function PayPalCancelResponse($order_id = null)
    {
        $orderData = array();
        $this->data['page_title'] = 'Order Details';
        if (!empty($order_id)) {
    ...
    public function UpdateOrderStatus($orderData = array())
    {
        $this->load->model('ProductOrder_Model');
        $this->load->model('Product_Model');
        $this->load->model('User_Model');
