...
class Orders extends Admin_Controller
{
    ...
    public function RemoveSingleProduct($product_id_key)
    {
        $json['success'] = 0;
    ...
    public function getProductList($fl = false)
    {
        $data['BASE_URL'] = base_url();
        if ($fl) {
    ...
    public function PrefferedCustomerDiscount()
    {
    ...
    public function shippingMethodFormate()
    {
        $shipping_fee = '';
