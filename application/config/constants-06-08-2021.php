...
function getRate($rate)
{
   ...
   function getOrderSatus($status=null){
	   ...
	   $statusData=array(1=>'Incomplete',2=>'New',3=>'Processing',4=>'Shipped',5=>'Delivered',6=>'Cancelled',7=>'Failed',8=>'Complete');
