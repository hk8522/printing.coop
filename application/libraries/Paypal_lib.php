...
class Paypal_lib
{
    ...
    function __construct(){
		...
		$this->CI->config->set_item('client_id','EAwnVhodJPgyBTp0CixePKN0vfzdM7mv4dugWNp3JOc_VPsf0HoXUj2PxImCbzUqVoVwIrYtX1NkwBPj');
		$this->CI->config->set_item('secret','EAwnVhodJPgyBTp0CixePKN0vfzdM7mv4dugWNp3JOc_VPsf0HoXUj2PxImCbzUqVoVwIrYtX1NkwBPj');
