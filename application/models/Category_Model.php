...
class Category_Model extends MY_Model
{
    ...
    public function getActiveProductListBySubCategoryId($category_id, $sub_category_id)
    {
        $data = array();
    ...
    public function getActiveProductListByCategoryId($category_id)
    {
        $data = array();
    ...
    public function getTotalActiveProduct()
    {
        $data = array();
        $this->db->select('id');
        $this->db->from('products');
